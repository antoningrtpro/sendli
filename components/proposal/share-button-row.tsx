...
interface ShareButtonRowProps {
  proposalId: string;
  slug: string;
}

export function ShareButtonRow({ proposalId, slug }: ShareButtonRowProps) {
  ...
  return (
    <>
      <button
        ...
        type="button"
        onClick={openPanel}
        className="inline-flex items-center justify-center w-7 h-7 rounded-full border border-gray-200 text-gray-400 hover:text-gray-700 hover:bg-gray-50 transition-all duration-150"
        title="Partager"
      >
      ...
      {open && pos && createPortal(
        <div
          ref={panelRef}
          className="fixed z-[9999] w-[420px] bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden"
          style={pos}
        >
          {/* Header */}
          ...
          <div className="p-4 space-y-4 max-h-[480px] overflow-y-auto">
            ...
            <div>
              ...
              {loading ? (
                <div className="text-center py-8 text-xs text-gray-300">Chargement…</div>
