...
CREATE TABLE "new_Proposal" (
    ...
    "clientLogoUrl" TEXT,
    "password" TEXT,
    "showPdfButton" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_Proposal" ("amountMrr", "amountOneShot", "bannerId", "blocks", "clientLogoUrl", "createdAt", "id", "password", "published", "slug", "status", "title", "updatedAt", "userId") SELECT "amountMrr", "amountOneShot", "bannerId", "blocks", "clientLogoUrl", "createdAt", "id", "password", "published", "slug", "status", "title", "updatedAt", "userId" FROM "Proposal";
DROP TABLE "Proposal";
